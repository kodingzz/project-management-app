...
export default function NoProject({onMakeProject}){
    return <div className='w-3/4 py-20 px-5 text-center'>
                ...
                <Button onClick={onMakeProject} className='bg-stone-900 rounded-md text-stone-300 hover:bg-stone-800 hover:text-stone-20 px-1 py-1'>Create a new project</Button>
         </div>
}