...
export default function SelectedProject({project,onDeleteProject,onAddTask,onDeleteTask,taskList}){
    ...
    return <div className="w-2/3 mt-16">
        <header className="pb-4 mb-4 border-b-2 border-stone-300 ">
            <div className="flex items-center justify-between">
                ...
                <button className="font-bold text-stone-700  hover:text-red-400 " onClick={onDeleteProject}>Delete</button>
            </div>
